...
export default {
  ...
  methods: {
    ...
    goToPage(currentpage = 1) {
      ...
      const api = `http://localhost:3000/api/products/getwarm/page=${this.currentpage}`;
      console.log(api);
...
.boy {
  ...
  height: 60vh;
  background-image: url('https://images.unsplash.com/photo-1562157873-818bc0726f68?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGNsb3RoZXN8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60');
}
/* .boy > img {
  height: 70vh;
  width: 100%;
