...
export default {
  ...
  methods: {
    ...
    goToPage(currentpage = 1) {
      ...
      const api = `http://localhost:3000/api/products/getshirt/page=${this.currentpage}`;
      console.log(api);
...
.boy {
  ...
  height: 60vh;
  background-image: url('https://images.pexels.com/photos/2205839/pexels-photo-2205839.jpeg?auto=compress&cs=tinysrgb&w=1600');
}
/* .boy > img {
  height: 70vh;
  width: 100%;
